...
|---|---|---|
| `CanonicalTurnOrchestrator` | compatibility re-export | Restored as explicit re-export; canonical owner remains `testbot.canonical_turn_orchestrator`; remove after in-repo imports/non-compat tests no longer use the façade path. |
